...
export const CustomerLoginView: React.FC = () => {
  ...
  // The "Demo Login" shortcut used to fake a signed-in user entirely in React
  // state. Now that the cart, orders and account pages read from the database
  // behind a real session, a fake one would only produce 401s — so it's gone and
  // the sign-up tab is the way in.
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="relative flex py-2 items-center mb-5">
            ...
            <span className="flex-shrink mx-3 text-xs text-gray-400 font-semibold uppercase">Or sign in with email</span>
            <div className="flex-grow border-t border-gray-200"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-xs">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-3.5 h-3.5 rounded border-gray-300 text-[#0056b3] focus:ring-[#0056b3]" />
                <span className="text-gray-600">Remember me</span>
              </label>
              <button type="button" className="text-[#0056b3] font-semibold hover:underline">
                Forgot password?
              </button>
            </div>
          ...
          <div className="mt-5 pt-4 border-t border-gray-100 text-center">
            <button
              ...
              type="button"
              className="text-xs text-gray-500 hover:text-[#0056b3] font-semibold transition-colors"
            >
        ...
        <p className="text-center mt-6 text-sm text-gray-500">
          ...
          <button
            onClick={() => navigateTo('customer-register')}
