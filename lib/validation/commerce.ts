...
const productFields = {
  ...
  weightKg: z.coerce.number().min(0).max(10000).transform((n) => n.toString()).nullable().optional(),
  lengthCm: z.coerce.number().min(0).max(1000).transform((n) => n.toString()).nullable().optional(),
  widthCm: z.coerce.number().min(0).max(1000).transform((n) => n.toString()).nullable().optional(),
  heightCm: z.coerce.number().min(0).max(1000).transform((n) => n.toString()).nullable().optional(),
  isFreeShipping: z.boolean().optional(),
  fixedShippingFee: money.nullable().optional(),
